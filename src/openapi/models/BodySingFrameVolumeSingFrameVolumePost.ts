 ...
 */
export function instanceOfBodySingFrameVolumeSingFrameVolumePost(
  value: object,
): boolean {
  let isInstance = true;
...
export function BodySingFrameVolumeSingFrameVolumePostFromJSON(
  json: any,
): BodySingFrameVolumeSingFrameVolumePost {
  return BodySingFrameVolumeSingFrameVolumePostFromJSONTyped(json, false);
}

export function BodySingFrameVolumeSingFrameVolumePostFromJSONTyped(
  json: any,
...
export function BodySingFrameVolumeSingFrameVolumePostToJSON(
  value?: BodySingFrameVolumeSingFrameVolumePost | null,
): any {
  if (value === undefined) {
    return undefined;
  }
