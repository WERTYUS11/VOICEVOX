 ...
 */
export function instanceOfBodySingFrameF0SingFrameF0Post(
  value: object,
): boolean {
  let isInstance = true;
...
export function BodySingFrameF0SingFrameF0PostFromJSON(
  json: any,
): BodySingFrameF0SingFrameF0Post {
  return BodySingFrameF0SingFrameF0PostFromJSONTyped(json, false);
}

export function BodySingFrameF0SingFrameF0PostFromJSONTyped(
  json: any,
...
export function BodySingFrameF0SingFrameF0PostToJSON(
  value?: BodySingFrameF0SingFrameF0Post | null,
): any {
  if (value === undefined) {
    return undefined;
  }
