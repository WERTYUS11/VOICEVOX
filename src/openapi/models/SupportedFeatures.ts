...
export function SupportedFeaturesFromJSONTyped(
  ...
  return {
    ...
    adjustPauseLength: !exists(json, "adjust_pause_length")
      ? undefined
      : json["adjust_pause_length"],
    ...
    manageLibrary: !exists(json, "manage_library")
      ? undefined
      : json["manage_library"],
    returnResourceUrl: !exists(json, "return_resource_url")
      ? undefined
      : json["return_resource_url"],
    applyKatakanaEnglish: !exists(json, "apply_katakana_english")
      ? undefined
      : json["apply_katakana_english"],
  };
}
